...
Installing "Eventbrite Integration" can be done either by searching for "Eventbrite Integration" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
