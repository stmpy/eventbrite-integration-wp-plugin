...
class Eventbrite_Integration {

	/**
	 * The single instance of Eventbrite_Integration.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function __construct ( $file = '', $version = '1.0.0' ) {
		...
		$this->_token = 'eventbrite_integration';
		...
		if ( is_admin() ) {
			$this->admin = new Eventbrite_Integration_Admin_API();
		}
	...
	public function register_post_type ( $post_type = '', $plural = '', $single = '', $description = '' ) {
		...
		$post_type = new Eventbrite_Integration_Post_Type( $post_type, $plural, $single, $description );
	...
	public function register_taxonomy ( $taxonomy = '', $plural = '', $single = '', $post_types = array() ) {
		...
		$taxonomy = new Eventbrite_Integration_Taxonomy( $taxonomy, $plural, $single, $post_types );
	...
	public function load_localisation () {
		load_plugin_textdomain( 'eventbrite-integration', false, dirname( plugin_basename( $this->file ) ) . '/lang/' );
	...
	/**
	 * Main Eventbrite_Integration Instance
	 *
	 * Ensures only one instance of Eventbrite_Integration is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Eventbrite_Integration()
	 * @return Main Eventbrite_Integration instance
	 */
