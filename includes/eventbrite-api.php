...
function eventbrite_api_load_keyring_service() {
	require_once( 'lib/class-eventbrite-api.php' );
}
...
function eventbrite_api_init() {
	...
	require_once( 'lib/class-eventbrite-requirements.php' );

	// No point loading unless we have an active Eventbrite connection.
	if ( Eventbrite_Requirements::has_active_connection() ) {
		require_once( 'lib/class-eventbrite-manager.php' );
		require_once( 'lib/class-eventbrite-query.php' );
		require_once( 'lib/class-eventbrite-templates.php' );
		require_once( 'lib/class-eventbrite-event.php' );
